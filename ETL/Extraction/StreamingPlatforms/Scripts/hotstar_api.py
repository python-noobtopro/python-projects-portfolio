...
for year in range(2019, 2025):
    ...
    for page in range(1, 100):
        ...
        headers = {
            ...
            'jw-session': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWRpZW5jZSI6InNlc3Npb24iLCJleHAiOjMyMzAxODMzNDksImlhdCI6MTcxNjQ1NTM0OSwiaXNzdWVyIjoianVzdHdhdGNoIiwic3ViIjoicHdWcVlRS25FZS1Yd1ZKdUVhOTVSQSJ9.5ixcK6eryjpL_fi9a_wy6hnVTonaKOlsg1CMr91DUv4',
        ...
        for movies in hotstar_movies:
            ...
            data_dict['MainLink'] = 'https://www.justwatch.com/in?providers=hst&release_year_from=2019'
            data_dict['Network'] = 'Hotstar'
...
df.to_excel('Justwatch_Hotstar_2019-24_230524.xlsx', index=False)
