...
for year in range(2019, 2025):
    ...
    for page in range(1, 100):
        ...
        headers = {
            ...
            'jw-session': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWRpZW5jZSI6InNlc3Npb24iLCJleHAiOjMyMjc3NDk5NzMsImlhdCI6MTcxNDAyMTk3MywiaXNzdWVyIjoianVzdHdhdGNoIiwic3ViIjoicHdWcVlRS25FZS1Yd1ZKdUVhOTVSQSJ9.N_bkEv0KGtfI0rrT7UVsFXsJnXAXlc1jd_lgCU5khWY',
    ...
    netflix_movies = response.json()["data"]["popularTitles"]["edges"]
    for movies in netflix_movies:
        data_dict = {}
        ...
        data_dict['Justwatch URL'] = 'https://www.justwatch.com' + url_trail
        data_dict['IMDB Score'] = imdb_score
        ...
        data_dict['Meta Description'] = metadesc
        data_dict['Full Poster URL Trail'] = fullposterurl_trail
        data_dict['Short Description'] = shortdesc
        data_dict['Release Year'] = release_year
        data_dict['Release Date'] = release_date
...
df.to_excel('Justwatch_Disney_Hotstar_2019-24_200524.xlsx', index=False)